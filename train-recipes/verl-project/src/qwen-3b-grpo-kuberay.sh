...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/s3/train-recipes/verl-project/src/verl/data/gsm8k/train.parquet \
    data.val_files=/s3/train-recipes/verl-project/src/verl/data/gsm8k/test.parquet \
