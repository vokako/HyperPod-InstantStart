  ...
  const handlePreview = async () => {
    try {
      ...
      const config = {
        ...
        deploymentName: selectedService?.deploymentName,
        ...
        >
          ...
          {selectedService && (
            <Alert
              ...
              message={
                <div>
                  <p><strong>Router Metric Port:</strong> {selectedService.metricPort}</p>
                  <p><strong>Deployment Name:</strong> {selectedService.deploymentName}</p>
